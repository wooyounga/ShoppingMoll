...
<body>
    ...
    <div class="body">
        ...
        <table class = 'board'>
            ...
            $sql = "select * from board order by b_no desc" . $sqlLimit;
            $stt = $db->prepare($sql);
            $stt -> execute();
            ...
            <tr>
                <td colspan="5">
                    ...
                    <div id="page_num">
                        <?php
                        if($page != 1) {
                            echo "<a href='./q_a_dis.php'>처음</a>";
                        }
                        if($currentSection != 1) {
                            echo "<a href='./q_a_dis.php?page=$prevPage'> 이전 </a>";
                        }
                        for($i = $firstPage; $i <= $lastPage; $i++) {
                            if($i == $page) {
                                echo "<b>".$i."</b>";
                            } else {
                                echo "<a href='./q_a_dis.php?page=$i'> $i </a>";
                            }
                        }
                        if($currentSection != $allSection) {
                            echo "<a href='./q_a_dis.php?page=$nextPage'> 다음 </a>";
                        }
                        if($page != $allPage) {
                            echo "<a href='./q_a_dis.php?page=$allPage'> 끝 </a>";
                        }
                        ?>
                    </div>
                </td>
